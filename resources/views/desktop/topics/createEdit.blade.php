    ...
    <div class="col-lg-12">
        <div class="panel panel-default shadow">
            ...
            <div class="panel-body">
                <form role="form" method="POST" action="{{ route('topic.save') }}" id="topic_form">
                    <input name="_method" type="hidden" value="PATCH" >
                    <input name="id" type="hidden" value="@if(old('id')){{{old('id')}}}@else{{{$topic->id}}}@endif">
                    {{ csrf_field() }}
...
@section('script')
    ...
    $(window).keydown(function(e) {
    	if (e.keyCode == 83 && e.ctrlKey) {
            ...
            data.id = $("#topic_form input[name=id]").val();
            ...
            Vue.http.post("{{ route('topic.save') }}", data).then(function(response) {
