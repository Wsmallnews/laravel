...
<style>
    .markdown_editor {height: 650px!important; padding: 10px;}
</style>
            ...
            <div class="panel-body">
                <form role="form" method="POST" action="{{ route('topic.update', ['id' => $topic->id]) }}" id="topic_form">
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <input type="text" class="form-control" id="title" name="title" placeholder="请填写标题" @if(old('title')) value="{{old('title')}}" @else value="{{$topic->title}}" @endif>
