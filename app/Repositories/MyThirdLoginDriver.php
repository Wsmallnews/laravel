...
class MyThirdLoginDriver{
     ...
     * @return User
     */
    protected function createThirdUser($driver, $socialiteUser)
    {
     ...
     * @author @smallnews 2017-01-20
     */
    protected function createQqUser($qqUser){
     ...
     */
    protected function createWeiboUser($weiboUser){
     ...
     * @author @smallnews 2017-03-17
     */
    protected function createTwitterUser($twitter){
